...
def enviar_oferta():
    ...
    st.session_state['df_aprobados'] = pd.DataFrame(beneficiarios_validados)
    st.session_state['df_aprobados']['Año'] = año_seleccionado
    st.session_state['df_aprobados']['Periodo'] = periodo_seleccionado
